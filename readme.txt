...
Registers nano-gpt.com AI (codex) as a provider for the WordPress AI Client. Supports text and image generation using NanoGPT's OpenAI-compatible API endpoints.
